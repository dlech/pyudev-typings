...
class Monitor:
    ...
    @classmethod
    def from_netlink(
        cls, context: Context, source: Literal["udev", "kernel"] = "udev"
    ) -> Self:
        """
    ...
    def filter_by(self, subsystem: str, device_type: str | None = None) -> None:
        """
    ...
    def receive_device(self) -> tuple[str | None, Device | None]:
        """
    ...
    def __iter__(self) -> Generator[tuple[str | None, Device], Any, NoReturn]:
        """
...
class MonitorObserver(Thread):
    ...
    """
    def __init__(
        self, monitor: Monitor, event_handler=..., callback=..., *args, **kwargs
    ) -> None:
        """
