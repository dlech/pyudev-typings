...
class Devices:
    ...
    @classmethod
    def from_name(
        cls, context: Context, subsystem: str | bytes, sys_name: str | bytes
    ) -> Device:
        """
    ...
    def from_device_number(
        cls, context: Context, typ: str | bytes, number: int
    ) -> Device:
        """
    ...
    @classmethod
    def from_device_file(cls, context: Context, filename: str | bytes) -> Device:
        """
...
class Device(collections.abc.Mapping[str, str]):
    """
    ...
    def __init__(self, context: Context, _device) -> None: ...
    ...
    @property
    def children(self) -> collections.abc.Generator[Device, Any, None]:
        """
    ...
    @property
    def ancestors(self) -> collections.abc.Generator[Device, Any, None]:
        """
    ...
    def find_parent(
        self, subsystem: str | bytes, device_type: str | bytes | None = None
    ) -> Device | None:
        """
    ...
    def traverse(self) -> collections.abc.Generator[Device, Any, None]:
        """
    ...
    @property
    def device_links(self) -> collections.abc.Generator[Any | str, Any, None]:
        """
    ...
    def __iter__(self) -> collections.abc.Generator[Any | str, Any, None]:
        """
...
class Properties(collections.abc.Mapping[str, str]):
    """
...
class Attributes:
    ...
    def __init__(self, device: Device) -> None: ...
    @property
    def available_attributes(self) -> collections.abc.Generator[str, Any, None]:
        """
    ...
    def get(
        self, attribute: str | bytes, default: str | bytes | None = None
    ) -> str | None:
        """
    ...
    def unset(self, attribute: str | bytes) -> None:
        """
...
class Tags(collections.abc.Iterable[str], collections.abc.Container[str]):
    """
