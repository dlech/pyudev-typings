...
class Context:
    ...
    def list_devices(self, **kwargs: int | bool | str | bytes) -> Enumerator:
        """
...
class Enumerator:
    ...
    def __del__(self) -> None: ...
    def match(self, **kwargs: int | bool | str | bytes) -> Self:
        """
    ...
    def match_property(
        self, prop: str | bytes, value: int | bool | bytes | str
    ) -> Self:
        """
