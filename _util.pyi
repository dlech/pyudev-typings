...
def ensure_byte_string(value) -> bytes:
    """
...
def ensure_unicode_string(value) -> str:
    """
...
def property_value_to_bytes(value) -> bytes:
    """
...
def udev_list_iterate(libudev, entry):  # -> Generator[tuple[Any, Any], Any, None]:
    """
...
def get_device_type(filename):  # -> Literal['char', 'block']:
    """
